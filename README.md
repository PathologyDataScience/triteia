...
The  `benchmark_interface` class is used to benchmark inference server requests. The class takes as input args and performs histomic stream study, load model, histomics stream inference.
