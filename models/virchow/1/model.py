...
# Architecture parameters from the Virchow model card, used if the downloaded
# config.json does not declare model_args. Taking `architecture` alone at face
# value would build timm's stock configuration for that name, which is not this
# model.
VIRCHOW_FALLBACK = {
...
class TritonPythonModel:
    ...
    def initialize(self, args):
        ...
        self.model, pretrained_cfg = _timm_from_local(
            weights_dir,
            fallback_args=VIRCHOW_FALLBACK,
