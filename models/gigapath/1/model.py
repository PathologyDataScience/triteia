"""Triton Python backend model for Prov-GigaPath on Quest.
...
class TritonPythonModel:
    ...
    def initialize(self, args):
        """Build Prov-GigaPath from weights staged in the user's directory."""
        ...
        self.model, pretrained_cfg = _timm_from_local(weights_dir)
