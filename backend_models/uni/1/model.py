...
class TritonPythonModel:
    ...
    def initialize(self, args):
        ...
        login(os.getenv("TOKEN"))  # login with your User Access Token, found at https://huggingface.co/settings/tokens
    ...
    def execute(self, requests):
        ...
        for request in requests:
            ...
            try:
                ...
                input_norm =(input_tensor / 255.0 - self.mean.reshape((1,3,1,1)))/(self.std.reshape((1,3,1,1)))
                ...
                out_tensor_features = pb_utils.Tensor("output_0", features.astype(np.float32))
